...
CR.trial <- TRUE
debug <- FALSE  # FALSE to read command line inputs
...
returnChartDataAndMetaData <- function (data,
                                        title,
                                        baseSize,
                                        questionID,
                                        keyOrder = "",
...
Ethnicity <- function() {
  ...
  result <- list(
    "title" = "Ethnicity",
    "pct.response" = as.data.frame(ethnicity.result),
    "n.valid" = S5.n.valid,
    "curr.id" = list("S5", "S6"),
...
Household.Composition <- function() {
  ...
  result <- list(
    ...
    "pct.response" = as.data.frame(hhcomp),
    "n.valid" = HHcompr5.n.valid,
    "curr.id" = list(
      "HHcompr2",
      "HHcompr3",
      "HHcompr4",
...
processedData <- list(
  ...
  "ethnicity" = formatted.slide4.r1c4.S5S6.ethnicity,
  "Household.Size" = formatted.slide4.r2c1.D1.HHSize,
  "household.composition" = formatted.slide4.r2c2.HHComp.household.composition,
  "generations" = formatted.slide4.r2c3.S4.generations,
  "urbanicity" = formatted.slide4.r2c4.D4.urbanicity,
