...
HHSize.Single.Column.Infer.N.Level <- function(curr.id, report.level) {
  curr.data <- Data.Value(curr.id)
...
out.slide4.r2c1.D1.HHSize.UK <-  HHSize.Single.Column.Infer.N.Level(
  curr.id = "D1", 
  report.level = c(1:5))
...
out.slide4.r2c3.S4.generations.VSB <-  Age.Single.Column.Infer.N.Level(
  curr.id = "S4", 
  report.level = c(1:4))
